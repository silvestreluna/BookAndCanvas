...
If you aren’t satisfied with the build tool and configuration choices, you can `eject` at any time. This command will remove asdfasdfsingle build dependency from your project.
...
![Product Details Page](./src/assets/mockups/BookAndCanvas-10.png)
